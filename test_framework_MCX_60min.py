...
while True:
    ...
    for scan_name in watchlist:
        ...
        try:
            ...
            print(f"   📊 RSI={cc['rsi']:.2f} | Market={cc['market_type']} | MACD={'✓' if bc4 else '✗'}")
    ...
    if orderbook[trading_symbol]['traded'] == "yes":
        try:
            ...
            if tg_hit:
                ...
                time.sleep(2)
                square_off_order = tsl.order_placement(tradingsymbol=trading_symbol, exchange='MCX', quantity=1, price=0, trigger_price=0, order_type='MARKET', transaction_type='SELL', trade_type='MIS')
                orderbook[trading_symbol]['exit_time'] = str(current_time.time())[:8]
