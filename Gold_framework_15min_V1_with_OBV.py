...
while True:
    ...
    for scan_name in watchlist:
        ...
        try:
            ...
            bc3 = cc['buy_signal']  # OBV condition
            ...
            print(f" 📈 MACD={macd_value:.2f} | Signal={macd_signal:.2f} | Zone={zone_color}{macd_zone}[/{zone_color.strip('[')}] | Status={status_color}{macd_status}[/{status_color.strip('[')}]")
            
            # OBV printing
            obv_value = cc['obv']
            obv_sma_value = cc['obv_sma']
            obv_above = cc['obv_above_sma']
            obv_cross = cc['obv_crossover']

            if obv_cross:
                obv_status = "Crossover ✅"
                
                
            elif obv_above:
                obv_status = "Above SMA"
                
            else:
                obv_status = "Below SMA"
